...
void main() {
  ...
  group('EventFeedbackScreen Tests', () {
    ...
    Widget createWidgetUnderTest() {
      return MaterialApp(home: EventFeedbackScreen(event: testEvent));
    }
    ...
    testWidgets('Star rating selection updates state', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createWidgetUnderTest());
    ...
    testWidgets('Displays reviews loaded from DatabaseHelper', (
      WidgetTester tester,
    ) async {
      final mockReviews = [
